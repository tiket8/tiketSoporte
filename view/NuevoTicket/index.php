...
<html>
	...
	<title> INAAPS D.I. :Nuevo Ticket</title>
</head>
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana podra generar nuevos tickets de Soporte.<br>
					(*) Datos Obligatorios
				</p>
					...
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								...
								<input type="text" class="form-control" id="tick_titulo" name="tick_titulo" placeholder="Ingresa un titulo que describa tu problema" required>
							</fieldset>
						</div>
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								...
								<div class="summernote-theme-1">
									<textarea id="tick_descrip" name="tick_descrip" class="summernote" placeholder="Describe con tus palabras la problematica o necesidad de tu solicitud" name="name" required></textarea>
								</div>
							</fieldset>
						</div>
