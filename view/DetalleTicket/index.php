...
?>
  ...
  <title> INAAPS D.I. :Detalle Ticket</title>
  </head>
              ...
              <div class="col-lg-12">
                ...
                <?php
                  if($_SESSION["rol_id"]==2){
                    ?>
                      <button type="button" id="btnchatgpt" class="btn btn-rounded btn-inline btn-success">Respuesta Automatica opcional</button>
                    <?php
                  }
                ?>
